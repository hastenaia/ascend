        ...
        >
          ...
          {hasNoParent && (
            <div className="rounded-xl border border-amber-200 bg-amber-50 p-3 text-xs leading-relaxed text-amber-800 dark:border-amber-900/40 dark:bg-amber-950/30 dark:text-amber-200">
              No active phase yet — your quest will be created as standalone and will still earn XP and grow your character when completed. Start a Journey to auto-link future quests to phases and milestones.
            </div>
          )}
